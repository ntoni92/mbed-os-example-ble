...
#define BLE_ROLE_OBSERVER                                  0//1                   // set by library:ble
#define BLE_ROLE_PERIPHERAL                                1                   // set by library:ble
#define DM_CONN_MAX                                        1//3                   // set by library:cordio
#define DM_NUM_ADV_SETS                                    1//3                   // set by library:cordio
#define DM_NUM_PHYS                                        0//3                   // set by library:cordio
#define DM_SYNC_MAX                                        0//1                   // set by library:cordio
#define HS_SPEED_XTAL                                      HS_SPEED_XTAL_32MHZ // set by target:STEVAL_IDB008V2
